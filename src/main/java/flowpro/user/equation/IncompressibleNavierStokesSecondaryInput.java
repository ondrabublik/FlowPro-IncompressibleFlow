...
public class IncompressibleNavierStokesSecondaryInput implements Equation {
    ...
    protected class BoundaryType {
        ...
        static final int INLET_2 = -5;
        static final int INLET_3 = -6;
    }
    ...
    public void init(FlowProProperties props) throws IOException {
        ...
        VInSecondary = props.getDoubleArray("VInSecondary");
		...
		if (props.containsKey("inletType")) {
			String type = props.getString("inletType").toLowerCase();
    ...
    public double[] numericalConvectiveFlux(double WL[], double WR[], double[] n, int TT, ElementData elem) {
        ...
        switch (TT) {
            ...
            case (BoundaryType.INLET_2):
            case (BoundaryType.INLET_3):
    ...
    public double[] boundaryValue(double[] WL, double[] n, int TT, ElementData elem) {
        ...
        switch (TT) {
            ...
            case (BoundaryType.INLET):
				...
				if (inletType == InletType.PARABOLA) {
                    double height = 1;
